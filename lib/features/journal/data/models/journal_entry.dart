...
class JournalEntry {
  ...
  JournalEntry copyWith({
    ...
    String? userId,
    String? content,
    Object? rawContent = _sentinel,
    Object? polishedContent = _sentinel,
    Object? mood = _sentinel,
    DateTime? entryDate,
    Object? entryTime = _sentinel,
    ...
    Object? sentimentScore = _sentinel,
    ...
    return JournalEntry(
      ...
      rawContent: rawContent == _sentinel ? this.rawContent : rawContent as String?,
      polishedContent: polishedContent == _sentinel ? this.polishedContent : polishedContent as String?,
      mood: mood == _sentinel ? this.mood : mood as String?,
      entryDate: entryDate ?? this.entryDate,
      entryTime: entryTime == _sentinel ? this.entryTime : entryTime as TimeOfDay?,
      ...
      sentimentScore: sentimentScore == _sentinel ? this.sentimentScore : sentimentScore as double?,
      emotion: emotion == _sentinel ? this.emotion : emotion as String?,
      tags: tags ?? this.tags,
